 ...
 * @author Jed Yang
 */
public class CarlUnweightedGraph implements UnweightedGraph {
    ...
    public CarlUnweightedGraph(boolean directed, int n) {
    ...
    public boolean addEdge(int begin, int end) {
        ...
        if(undirected && (begin != end)) {
            ...
            adj.get(end).add(-i-1, new Integer(begin));
        }
        return true;
    }
